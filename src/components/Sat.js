...
function Sat() {
    return (
        <Card title='SAT'>
            ...
            <a target="_blank" rel="noreferrer" href="https://www.mi-rfc.com.mx/consulta-rfc-homoclave">RFC Alt</a><br />
            ...
            <a target="_blank" rel="noreferrer" href="https://www.sat.gob.mx/personas/tramites-del-rfc">Más trámites del RFC</a><br />
        </Card>
    )
}
